 ...
 <!-- App Capsule -->
    <div id="appCapsule">
        <div class="section mt-2 text-center">
            <img src="'.$base_url.'mod/assets/img/bitmap.png" alt="icon" class="loading-icon">
            <h1>Masuk</h1>
        </div>
            ...
            <div class="card">
                <div class="table-responsive">
                    <table class="table table-dark rounded bg-danger">
                        ...
                        <tbody>';
                        $query_absen="SELECT presence_date,time_in,time_out FROM presence WHERE MONTH(presence_date) ='$month' AND employees_id='$row_user[id]' ORDER BY presence_date DESC LIMIT 6";
