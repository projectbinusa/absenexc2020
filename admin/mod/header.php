...
<head>
  ...
  <link rel="shortcut icon" href="'.$site_url.'/content/favicon.png">
  <link rel="apple-touch-icon" href="'.$site_url.'/content/favicon.png">
  <link rel="apple-touch-icon" sizes="72x72" href="'.$site_url.'/content/favicon.png">
  <link rel="apple-touch-icon" sizes="114x114" href="'.$site_url.'/content/favicon.png">
