        ...
        <tr style="background:'.$background.';color:'.$warna.'">
          ...
          <td class="text-center picture">';
            if($row_absen['picture_in'] ==NULL){
              ...
              echo'<a class="image-link" href="'.$site_url.'/content/absent/'.$row_absen['picture_in'].'">
              <img src="../timthumb?src='.$site_url.'/content/absent/'.$row_absen['picture_in'].'&h=40&w=40"></a>';
            }
          echo'
          </td>
          ...
          <td class="text-center picture">';
              if($row_absen['picture_out'] ==NULL){
                ...
                echo'<a class="image-link" href="'.$site_url.'/content/absent/'.$row_absen['picture_out'].'">
                      <img src="../timthumb?src='.$site_url.'/content/absent/'.$row_absen['picture_out'].'&h=40&w=40"></a>';}
              echo'</td>
