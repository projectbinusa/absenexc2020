<?php session_start();
    ...
    require_once'../mod/out/cookies.php';
        ...
        if($result->num_rows > 0){
          ...
          // Update Absensi Pulang
              if($row['time_out']=='00:00:00'){
                ...
                $directory= "../content/absent/".$filename;
                /* -------- Upload Foto Pulang -------*/
    ...
    if($result_absen->num_rows > 0){
      ...
      if($row_absen['status']=='Telat'){
        ...
        <tr>
            ...
            <td><a class="image-link" href="./content/absent/'.$row_absen['picture_in'].'">
            <span class="badge badge-success">'.$row_absen['time_in'].'</span></a>'.$status.'</td>

            <td><a class="image-link" href="./content/absent/'.$row_absen['picture_out'].'">
